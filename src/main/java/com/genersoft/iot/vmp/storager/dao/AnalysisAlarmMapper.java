...
public interface AnalysisAlarmMapper {
     ...
     * 根据设备和通道查询告警
     */
    @Select("SELECT * FROM wvp_analysis_alarm WHERE device_id = #{deviceId} AND channel_id = #{channelId} " +
     ...
     * 查询最近的告警
     */
    @Select("SELECT * FROM wvp_analysis_alarm " +
     ...
     * 查询待处理告警
     */
    @Select("SELECT * FROM wvp_analysis_alarm WHERE status = 'PENDING' ORDER BY alarm_time DESC")
     ...
     * 根据设备ID查询告警
     */
    @Select("SELECT * FROM wvp_analysis_alarm WHERE device_id = #{deviceId} ORDER BY alarm_time DESC")
